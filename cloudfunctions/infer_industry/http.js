 ...
 *   const text = await http.getText('https://example.com/api');
 *   const json = await http.getJSON('https://example.com/api');
 *   const json = await http.postJSON('https://example.com/api', { k: 'v' }, { headers: {...} });
 */
 ...
 * @returns {Promise<{status:number, text:string, json:Function}>}
 */
