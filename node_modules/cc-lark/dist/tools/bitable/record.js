...
// Tool registration
// ---------------------------------------------------------------------------
export function registerBitableRecordTool(registry) {
...
async function handleBatchCreate(args, context) {
    const p = args;
    const { larkClient } = context;
    const accessTokenResult = await getAccessToken(context);
    if (typeof accessTokenResult === 'object' && 'content' in accessTokenResult) {
...
async function handleBatchUpdate(args, context) {
    const p = args;
    const { larkClient } = context;
    const accessTokenResult = await getAccessToken(context);
    if (typeof accessTokenResult === 'object' && 'content' in accessTokenResult) {
...
async function handleBatchDelete(args, context) {
    const p = args;
    const { larkClient } = context;
    const accessTokenResult = await getAccessToken(context);
    if (typeof accessTokenResult === 'object' && 'content' in accessTokenResult) {
