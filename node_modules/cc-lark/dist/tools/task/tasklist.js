...
import { json, jsonError } from '../im/helpers.js';
...
async function getAccessToken(context) {
    ...
    if (!larkClient)
        return jsonError('LarkClient not initialized.');
...
export function registerTasklistTool(registry) {
    registry.register({
        ...
        handler: async (args, context) => {
            ...
            if (typeof tokenResult === 'object' && 'content' in tokenResult)
                return tokenResult;
            const accessToken = tokenResult;
            log.info(`create: name=${p.name}`);
            const Lark = await import('@larksuiteoapi/node-sdk');
            const opts = Lark.withUserAccessToken(accessToken);
            const res = await larkClient.sdk.task.v2.tasklist.create({ data: { name: p.name }, params: { user_id_type: 'open_id' } }, opts);
            assertLarkOk(res);
    ...
    registry.register({
        ...
        handler: async (args, context) => {
            ...
            const Lark = await import('@larksuiteoapi/node-sdk');
            const opts = Lark.withUserAccessToken(accessToken);
            const res = await larkClient.sdk.task.v2.tasklist.get({ path: { tasklist_guid: p.tasklist_guid }, params: { user_id_type: 'open_id' } }, opts);
            assertLarkOk(res);
            return json({ tasklist: res.data?.tasklist });
        },
    });
    registry.register({
        ...
        handler: async (args, context) => {
            ...
            const Lark = await import('@larksuiteoapi/node-sdk');
            const opts = Lark.withUserAccessToken(accessToken);
            const res = await larkClient.sdk.task.v2.tasklist.list({ params: { page_size: p.page_size, page_token: p.page_token, user_id_type: 'open_id' } }, opts);
            assertLarkOk(res);
    ...
    registry.register({
        ...
        handler: async (args, context) => {
            ...
            const Lark = await import('@larksuiteoapi/node-sdk');
            const opts = Lark.withUserAccessToken(accessToken);
            const res = await larkClient.sdk.task.v2.tasklist.tasks({ path: { tasklist_guid: p.tasklist_guid }, params: { page_size: p.page_size, page_token: p.page_token, completed: p.completed, user_id_type: 'open_id' } }, opts);
            assertLarkOk(res);
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            const data = res.data;
            return json({
    ...
    registry.register({
        ...
        handler: async (args, context) => {
            ...
            const res = await larkClient.sdk.task.v2.tasklist.patch({ path: { tasklist_guid: p.tasklist_guid }, data: { tasklist: tasklistData, update_fields: updateFields }, params: { user_id_type: 'open_id' } }, opts);
            assertLarkOk(res);
            return json({ tasklist: res.data?.tasklist });
        },
    });
    registry.register({
        ...
        handler: async (args, context) => {
            ...
            const Lark = await import('@larksuiteoapi/node-sdk');
            const opts = Lark.withUserAccessToken(accessToken);
            const res = await larkClient.sdk.task.v2.tasklist.delete({ path: { tasklist_guid: p.tasklist_guid } }, opts);
            assertLarkOk(res);
