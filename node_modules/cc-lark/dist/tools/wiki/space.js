...
export function registerWikiSpaceTool(registry) {
    registry.register({
        ...
        handler: async (args, context) => {
            ...
            const res = await larkClient.sdk.wiki.space.list({ params: { page_size: p.page_size, page_token: p.page_token } }, opts);
            assertLarkOk(res);
            const data = res.data;
            return json({
                spaces: data?.items,
